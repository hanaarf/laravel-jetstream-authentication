            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped verticle-middle table-responsive-sm">
                       <a href="/dbadmin-form-jeniskonseling">
                       ...
                       <tbody>
                            @foreach ($jeniskonseling as $item)
                            <tr>
                                <td>{{ $item->id }}</td>
                                <td>{{ $item->name }}</td>
                                <td>
                                    <span style="display: flex">
                                        <a href="/dbadmin/{{ $item->id }}/editjeniskonseling">
                                            <button type="submit" class="ml-3 btn btn-primary shadow btn-xs sharp"><i class="fa fa-pencil color-muted"></i>  </button>
                                        </a><br>
                                      
                                        <form action="/dbadmin-hapusjeniskonseling/{{ $item->id }}" method="POST"
