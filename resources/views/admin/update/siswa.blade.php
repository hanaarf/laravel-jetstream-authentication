            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        ...
                        <form method="POST" action="/dbadmin-simpaneditsiswa/{{ $siswa->id}}"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="user_id" class="form-control default-select" id="maapel">
                                        <option value="{{ $siswa->userid->id }}" selected>{{ $siswa->userid->name }}
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="kelas_id" class="form-control default-select" id="maapel">
                                        <option value="{{ $siswa->kelasid->id }}" selected>{{ $siswa->kelasid->name }}
