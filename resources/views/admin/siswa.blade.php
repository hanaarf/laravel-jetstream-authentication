                    ...
                    <br><table id="example3" class="display" style="min-width: 845px">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="javascript:void(0);"><strong>{{ $item->kelasid->name }}</strong></a></td>
                                <td>{{ $item->ttl }}</td>
                                <td>{{ $item->nisn }}</td>
                                <td><a href="/dbadmin/detailsiswa/{{ $item->id }}"><div class="badge badge-primary">detail</div></a></td>
                                <td>
                                    <div class="d-flex">
                                        <a href="/dbadmin/{{ $item->id }}/editsiswa" ><button type="button" class="ml-3 mb-1 btn btn-primary shadow btn-xs sharp mr-1">   <i class="mdi mdi-border-color"></i> </button></a>

                                        <form action="/dbadmin-hapussiswa/{{ $item->id }}" method="POST"
