            ...
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 fs-14">
                        ...
                        <span class="text-success mr-1">total of</span>teacher
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 fs-13">
                        ...
                        <span class="text-success mr-1">total of</span>class
                    </p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 m-t35">
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <h2 class="text-black mb-2 font-w600">{{ $walas }}</h2>
                    <p class="mb-0 fs-14">
                        <svg width="29" height="22" viewbox="0 0 29 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-danger mr-1">total of</span>hr teacher
                    </p>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6 m-t35">
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <h2 class="text-black mb-2 font-w600">{{ $siswa }}</h2>
                    <p class="mb-0 fs-14">
                        <svg width="29" height="22" viewbox="0 0 29 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="text-success mr-1">total of</span>students
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 fs-14">
                        ...
                        <span class="text-success mr-1">total</span>student
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 fs-13">
                        ...
                        <span class="text-success mr-1">total</span>hr teacher
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 fs-14">
                        ...
                        <span class="text-danger mr-1">total</span>counsultant
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="card card-coin">
                <div class="card-body text-center">
                    ...
                    <p class="mb-0 fs-14">
                        ...
                        <span class="text-success mr-1">total</span>class
                    </p>
                </div>
            </div>
        </div>
