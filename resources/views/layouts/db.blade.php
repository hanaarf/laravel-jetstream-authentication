    ...
    ***********************************-->
    <div id="main-wrapper">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{ route('logout') }}" class="dropdown-item hover:bg-white/5"
                                        ...
                                        <i data-lucide="toggle-right" class="w-4 h-4 mr-2">
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/dbadmin-alluser">User</a></li>

                            <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Detail User</a>
                                <ul aria-expanded="false">
                                    <li><a href="/dbadmin-murid"> Student</a></li>
                                    <li><a href="/dbadmin-gurubk"> Teacher</a></li>
                                    <li><a href="/dbadmin-walas"> Homeroom Teacher</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    ...
                    {{-- <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/dbadmin-allcounseling">All counseling</a></li>

                            <li><a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Detail
                                    Counseling</a>
                                <ul aria-expanded="false">
                                    <li><a href="/dbadmin-bimbingansosial">social guidance</a></li>
                                    <li><a href="/dbadmin-bimbingankarir">career guidance</a></li>
                                    <li><a href="/dbadmin-bimbingansosialisasikarir">career socialization guidance</a>
                                    </li>
                                    <li><a href="/dbadmin-bimbinganbelajar">tutoring</a></li>
                                    <li><a href="/dbadmin-bimbingankonselingpribadi">personal counseling guidance</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li><a href="/dbadmin-petakerawanan" class="ai-icon" aria-expanded="false">
                ...
                <div class="copyright">
                    <p><strong>DeepMind Admin Dashboard</strong> © 2023 All Rights Reserved</p>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href=".index.htm" target="_blank">DeepMind</a> 2023
                </p>
            </div>
        </div>
        <!--**********************************
