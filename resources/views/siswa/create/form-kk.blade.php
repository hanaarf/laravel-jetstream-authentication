        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/dbsiswa-form-konselingkelompok" method="POST">
                        @csrf
                        ...
                        <div class="form-group col-md-12">
                         ...
                         <div class="form-group col-md-12">
                            ...
                            <select select class="multi-select" name="siswa_id[]" multiple="multiple">
                                <option value="{{ $siswa1->id }}"
                                    selected>{{ $siswa1->name }}
                                @foreach ($siswa as $jenis)
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select name="walas_id" id="walas_id" class="form-control">
                                <option value="{{ $walas1->id }}" selected>{{ $walas1->name }}
                                @foreach ($walas as $jenis)
                                <option value="{{ $jenis->id }}">{{ $jenis->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            <label for="gurubk_id">gurubk</label>
                            <select name="gurubk_id" id="gurubk_id" class="form-control">
                                <option value="{{ $gurubk1->id }}"
                                    selected>{{ $gurubk1->name }}
                                @foreach ($gurubk as $jenis)
                                <option value="{{ $jenis->id }}">{{ $jenis->name }}</option>
                                @endforeach
                            </select>
                        </div>
